...
// });
  ...
  if ($(".count-box").length) {
    $(".count-box").appear(
        function () {
            var $t = $(this),
                stopValue = parseInt($t.find(".count-text").attr("data-stop"), 10),
                speed = parseInt($t.find(".count-text").attr("data-speed"), 10),
                unit = $t.find(".count-text").attr("data-unit") || "";
            ...
            if (!$t.hasClass("counted")) {
                ...
                $({ countNum: 0 }).animate(
                    { countNum: stopValue },
                    {
                        ...
                        easing: "linear",
                        step: function () {
                            $t.find(".count-text").text(Math.floor(this.countNum) + unit);
                        },
                        complete: function () {
                            $t.find(".count-text").text(this.countNum + unit);
                        }
                    }
                );
            }
